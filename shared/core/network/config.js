...
import { FireDamageAreaEntitySchema, VisualsEntitySchema } from './entities.js'
import { ChatMessageSchema, ChangePlayerObjectMessageSchema, LoseAbilityMessageSchema, ObtainAbilityMessageSchema, PlaySoundMessageSchema, PlayerCountMessageSchema, AllPlayerPositionsMessageSchema } from './messages.js'
...
context.register(NType.FireDamageAreaEntity, FireDamageAreaEntitySchema)
...
context.register(NType.PlayerCountMessage,PlayerCountMessageSchema)
